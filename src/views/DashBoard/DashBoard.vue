<template>
  <div class="tw:grid tw:grid-cols-12 tw:gap-2">
    ...
    >
      <VelocityShow
        class="tw:hover:-translate-y-2 tw:hover:!shadow-m-elevation-12 tw:ease-in-out tw:!transition-all tw:duration-500 border-thin tw:hover:!bg-m-grey-lighten3 tw:dark:hover:!bg-m-grey-darken3"
      />
    </div>
    <div
    ...
    <div
      class="tw:col-span-12 tw:md:col-span-9 tw:bg-slate-700 tw:rounded-xl tw:!mr-2.5 tw:motion-translate-x-in-[-85%] tw:motion-translate-y-in-[-65%] tw:motion-blur-in-[30px] tw:motion-ease-spring-bouncier tw:motion-delay-500"
    >
      <div>快速指令</div>
    </div>
  </div>
